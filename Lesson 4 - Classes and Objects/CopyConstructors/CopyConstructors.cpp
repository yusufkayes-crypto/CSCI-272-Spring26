...
2. Difficulties:
 In the beginning, I struggled with understanding the need for a default Constructor
3. Research:
...
5. What I learned:
 I learned that new requires delete, when to use default constructors, how constructors differ from member functions
